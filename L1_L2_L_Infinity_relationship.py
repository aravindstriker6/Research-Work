...
import L1_L2_L_infinity_Edge_Matrix
...
for subsample_size in subsample_sizes:
    ...
    for rep in range(num_reps):
        ...
        for eps in eps_user:
            edge_matrix, total_edge_matrix, total_edges,storage_same_metrics, storage_different_metrics= L1_L2_L_infinity_Edge_Matrix.edge_matrix_calculator(eps,X_c1_curr,X_c2_curr,storage_same_metrics, storage_different_metrics)
